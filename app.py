...
#PostgreSQL is configured to be used in Heroku and hence an environment variable is set up to access PostgreSQL settings
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///data.db')  # sqlite is passed as a secondry argument
